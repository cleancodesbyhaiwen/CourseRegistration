...
def main():
  ...
  if current_user.is_student:
    ...
    SELECT Courses.name, Courses.c_id, Courses.course_header, Courses.college,Courses.credit,
    ...
    if request.method == 'POST':
      ...
      if request.form.get('search'):
        ...
        all_time_periods=all_time_periods,enrolled_counts=enrolled_counts)
  ...
  ########################################################
    ...
    courses_teach = g.conn.execute('''
          SELECT *
          FROM Courses, Instruct
          WHERE Courses.id=Instruct.course_id and Instruct.instructor_id={}
          '''.format(current_user.get_id()))
